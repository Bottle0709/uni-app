		...
		randomfn() {
			...
			for (let i = 0, length = this.tabBars.length; i < length; i++) {
				...
				if (this.tabBars[i].template === 'index') {
					aryItem.data.banners = [{ src: '../../static/images/1.jpg' }, { src: '../../static/images/2.jpg' }];
					aryItem.data.indexNav = [
						...
						{ src: '../../static/indexnav/sw.png', name: '失物招领', url: '' },
						{ src: '../../static/indexnav/xw.png', name: '寻物启事', url: '' },
						{ src: '../../static/indexnav/g.png', name: '更多', url: '' }
					];
					aryItem.data.indexNav2 = [
						{ src: '../../static/indexnav/1.png', name: '人脸识别', url: '' },
						{ src: '../../static/indexnav/2.gif', name: '我的车辆', url: '../../pages/vehicle/mycart' },
						{ src: '../../static/indexnav/3.gif', name: '停车缴费', url: '../../pages/vehicle/mycart' },
						{ src: '../../static/indexnav/4.gif', name: '扫码充电', url: '../../pages/scan/scan' },
						{ src: '../../static/indexnav/5.gif', name: '联系物业', url: '' },
						{ src: '../../static/indexnav/6.gif', name: '在线报修', url: '' },
						{ src: '../../static/indexnav/7.gif', name: '投诉建议', url: '' },
						{ src: '../../static/indexnav/8.gif', name: '更多', url: '' }
					];
					aryItem.data.list = [
						{
							// 三屏广告
							type: 'ThreeAdverts',
							data: [{ src: '../../static/images/demo/demo1.jpg' }, { src: '../../static/images/demo/demo2.jpg' }, { src: '../../static/images/demo/demo2.jpg' }]
						},
						{
							// 大图广告
							type: 'OneAdvert',
				...
				if (this.tabBars[i].template === 'special') {
					aryItem.data.banners = [{ src: '../../static/images/demo/demo4.jpg' }, { src: '../../static/images/demo/demo8.jpg' }];
					aryItem.data.indexNav = [
