						...
						<uni-card>
							<view class="recodlist">
								...
								<view class="foot" :class="'jsc'+item.status">
									<view class="detail" v-if="item.status == 0"><button class="sa sa1" type="primary">预约</button></view>
...
export default {
	data() {
		return {
			...
			statuslist: [{ id: 0, name: '未占用' }, { id: 1, name: '预约中' }, { id: 2, name: '充电中' }, { id: 3, name: '未付款' }, { id: 4, name: '已完成' }],
			isNoData: false,
			recordlist: [
				{
					id: 0,
