    ...
    <uni-card class="engte">
      ...
      <view class="info-list info-list2">
        ...
        <view class="l-if text-box" scroll-y="true">
          <text
            >工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单工单</text
          >
        </view>
      </view>
      <view class="foot">
        <view class="detail"
          ><button class="sa sa1" type="primary">接收</button></view
        >
        <view class="detail"
          ><button class="sa" type="primary">完成</button></view
        >
        <view class="detail"
          ><button class="sa sa2" type="primary" @click="open">
            未完成
          </button></view
        >
      </view>
